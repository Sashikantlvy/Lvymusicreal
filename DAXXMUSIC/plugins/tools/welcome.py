...
def welcomepic(pic, user, chatname, id, uname):
    ...
    draw.text((2220, 1200), f'ID: {id}', fill=(300, 300, 300), font=font)
...
➖➖➖➖➖➖➖➖➖➖➖➖**
""",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f"⦿ ᴀᴅᴅ ᴍᴇ ⦿", url=f"https://t.me/lvy_music_bot?startgroup=true")]])
        )
    except Exception as e:
        LOGGER.error(e)
    try:
